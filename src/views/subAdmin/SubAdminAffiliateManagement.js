...
import { subAdminTableConfig } from '../base/tableConfig/subAdminTableConfig'
import { subAdminServices } from '../../service/subAdminServices'

const SubAdminAffiliateManagement = () => {
  ...
  const fetchSubAdmins = async () => {
    setLoading(true)
    try {
      const response = await subAdminServices.SubAdminAffiliateList(filters)
...
export default SubAdminAffiliateManagement
